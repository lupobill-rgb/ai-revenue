...
const SAMPLE_VIDEOS = [
  {
    id: "video-1",
    name: "Summer Pickleball Championship Promo",
    description: "High-energy promotional video showcasing annual championship",
    status: "live",
    views: 45200,
    duration: "0:45",
  ...
  {
    id: "video-2",
    name: "Luxury Resort Virtual Tour",
    description: "Immersive walkthrough of resort amenities and rooms",
    status: "live",
    views: 32100,
    duration: "2:30",
  ...
  {
    id: "video-3",
    name: "Fitness Pro Gym - New Year Promo",
    description: "Motivational video for New Year membership drive",
    status: "approved",
    views: 18500,
    duration: "1:15",
  ...
  {
    id: "video-4",
    name: "Physical Therapy Success Stories",
    description: "Patient testimonials and recovery journeys",
    status: "review",
    views: 0,
    duration: "3:00",
