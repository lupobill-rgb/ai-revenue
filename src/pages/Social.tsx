...
const SAMPLE_POSTS = [
  {
    id: "social-1",
    name: "Championship Highlights Reel",
    platform: "Instagram",
    content: "🏆 What an incredible weekend at the Summer Pickleball Championship! Swipe to see the best moments →",
    status: "live",
    likes: 2450,
    comments: 187,
    shares: 89,
    impressions: 45200,
    engagement: 6.1,
    thumbnail: "/placeholders/pickleball-social.jpg",
  ...
  },
  {
    ...
    platform: "LinkedIn",
    content: "The hospitality industry is evolving rapidly. Here are 5 trends that will shape 2025...",
    status: "live",
    likes: 892,
    comments: 67,
    shares: 234,
    impressions: 18900,
    engagement: 6.3,
    thumbnail: "/placeholders/pickleball-landing.jpg",
  ...
  },
  {
    ...
    platform: "Facebook",
    content: "🎉 Our biggest sale of the year is HERE! Limited spots available for our New Year membership...",
    status: "approved",
    likes: 0,
    comments: 0,
    shares: 0,
    impressions: 0,
    engagement: 0,
    thumbnail: "/placeholders/pickleball-email.jpg",
  ...
  },
  {
    ...
    platform: "Instagram",
    content: "Take a peek behind the curtain! Here's how we prepare for each tournament 🎬",
    status: "review",
    likes: 0,
    comments: 0,
    shares: 0,
    impressions: 0,
    engagement: 0,
    thumbnail: "/placeholders/pickleball-video.jpg",
